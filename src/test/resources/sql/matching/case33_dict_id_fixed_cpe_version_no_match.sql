...
-- Should NOT match when installed software version differs.

INSERT INTO cpe_vendors (id, name_norm, display_name, source, created_at, updated_at)
VALUES (91002, 'mozilla', 'Mozilla', 'CPE_DICT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO cpe_products (id, vendor_id, name_norm, display_name, source, created_at, updated_at)
VALUES (92002, 91002, 'firefox', 'Firefox', 'CPE_DICT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO assets (
    id, external_key, name, asset_type, owner, note,
    source, platform, os_version, created_at, updated_at, last_seen_at
) VALUES (
             93002, 'asset-fixed-version-no-match', 'Host-Fixed-Version-NoMatch', 'WORKSTATION', null, null,
...
INSERT INTO software_installs (
    ...
    created_at, updated_at, cpe_vendor_id, cpe_product_id, canonical_link_disabled
             ...
             94002, 93002, 'APPLICATION', 'MANUAL',
             'Mozilla', 'Mozilla Firefox (x64 en-US)', '148.0', '148.0', CURRENT_TIMESTAMP, null,
             null, null, null, 'x64', 'UNKNOWN',
             null, null, null, null, null, null, null, null,
             'Mozilla', 'Mozilla Firefox (x64 en-US)', '148.0', null, 'mozilla', 'firefox',
             CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 91002, 92002, false
         );
...
INSERT INTO vulnerabilities (
    ...
    published_at, last_modified_at, kev_flag, created_at, updated_at
             ...
             95002, 'NVD', 'CVE-2099-9033',
             'Fixed-version CPE should not match different software version',
             'HIGH', '3.1', 7.5,
...
INSERT INTO vulnerability_affected_cpes (
    ...
    criteria_node_id, root_group_no, dedupe_key, created_at, updated_at
             ...
             96002, 95002, 'cpe:2.3:a:mozilla:firefox:129.0:*:*:*:*:*:*:*',
             91002, 92002,
             'mozilla', 'firefox',
             'a', '*', '*',
             '', '', '', '',
             null, 0, 'case33-fixed-version-no-match', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
         );